...
<v-app id="inspire">
    ...
    >
      ...
      <v-img
        height="400"
        src="https://e7.pngegg.com/pngimages/652/807/png-clipart-code-barres-2d-qr-code-business-information-e-commerce-business-text-rectangle-thumbnail.png"
      ></v-img>
   ...
   <div class="container">
      <div class="welcome-wrapper">
            <div class="welcome-content animate__animated animate__backInLeft">
              ...
              <NuxtLink to="/signin">
                <button v-if="this.token == null " class="btn welcome-btn">Генерировать</button>
              </NuxtLink>
              <button v-if="this.token !== null "  @click="dialog2 = !dialog2" class="btn welcome-btn">Генерировать</button>
              <!-- <a href="/signin"></a> -->
            </div>
            <div class="welcome-Aframe animate__animated animate__backInRight" style="overflow: hidden;">
              <iframe height="100%" src="https://city.ultiverse.io" style="width: calc(100% + 20px)"  class="overflow-hidden" frameborder="0"></iframe>  
            </div>   
        </div>
   </div>
